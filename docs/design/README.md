...
| 04 | [popup-layout.md](04-popup-layout.md) | 菜单栏 popup 面板 560pt 布局 + 卡片/行/用量区 | 改 popup 时读 |
| 05 | [main-window-and-theme.md](05-main-window-and-theme.md) | 主窗口 NavigationSplitView + 5 Pages + 13 Shared 组件 + Theme token | 改主窗口/视觉时读 |
